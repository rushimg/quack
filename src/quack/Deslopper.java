...
public class Deslopper {
    ...
    public static final double inferencePenalty = 0; //1.0 / 10;
    
    public static final double funcCallPenalty = 1.0 / 100;

    public static final double unusedWordsPenalty = 1.0 / 100000;

    public static final double contextDistBonus = 1.0 / 100000;
    
    public static final double callCountBonus = 1.0 / 100000;
    
    public static final double maxAcceptablePenalty = 0.3;
                ...
                for (Func f : funcs) {
                    ...
                    if (score == null) {
                        ...
                        if (funcIdent.regex == null) {
                            ...
                            score.sideScore -= unusedWordsPenalty * unusedWords;
                        ...
                        if (inferred) {
                            ...
                            // if this is a literal, we can't infer it...
                            if (f.literal) {
                                score.sideScore -= 1000000.0;
                            }
                        }
                        
                        // base penalty for all function calls
                    ...
                    if (f.contextDist > 0) {
                        score.sideScore += contextDistBonus
                                * (100 - f.contextDist);
                    }

                    // give bonus to commonly called functions
                    score.sideScore += callCountBonus
                            * Math
